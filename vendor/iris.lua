...
c(
    ...
    function(require, n, c, d)
        ...
        function o._cycle()
            ...
            if
                o.parentInstance:IsA("GuiBase2d") and
                    math.min(o.parentInstance.AbsoluteSize.X, o.parentInstance.AbsoluteSize.Y) < 100
             then
                error("Iris Parent Instance is too small")
            end
            local D =
                o.parentInstance:IsA("GuiBase2d") or o.parentInstance:IsA("CoreGui") or
                o.parentInstance:IsA("PluginGui") or
                o.parentInstance:IsA("PlayerGui")
            if D == false then
    ...
    function(require, n, c, d)
        ...
        return function(o)
            ...
            local function c2(c3, c4, c5, c6)
                ...
                c3.InputBegan:Connect(
                    function(c8)
                        if
                            not (c8.UserInputType == Enum.UserInputType.MouseButton1 or
                                c8.UserInputType == Enum.UserInputType.Gamepad1)
                         then
                            return
                        end
                        if c6 == "Text" then
                ...
                c3.InputEnded:Connect(
                    function(c8)
                        if
                            not (c8.UserInputType == Enum.UserInputType.MouseButton1 or
                                c8.UserInputType == Enum.UserInputType.Gamepad1) or c7
                         then
                            return
                        end
            ...
            do
                ...
                o.WidgetConstructor(
                    ...
                    {Args = {}, Generate = function(L)
                            ...
                            cm.Parent = cl
                            return ck
                        end, Update = function(L)
                            if cj > 0 then
                                L.Instance.PseudoWindowScreenGui.PseudoWindow.Visible = true
                            end
                        end, Discard = function(L)
                            cj = 0
                            L.Instance:Destroy()
                        end, ChildAdded = function(L, cn)
                        ...
                        end, ChildDiscarded = function(L, cn)
                            if cn.type ~= "Window" then
                                cj = cj - 1
                                if cj == 0 then
            ...
            o.WidgetConstructor(
                ...
                false,
                false,
                {Args = {["Text"] = 1}, Generate = function(L)
            ...
            o.WidgetConstructor(
                ...
                false,
                true,
                {Args = {["Width"] = 1}, Generate = function(L)
            ...
            o.WidgetConstructor(
                ...
                false,
                true,
                {Args = {["Width"] = 1, ["VerticalAlignment"] = 2}, Generate = function(L)
            ...
            o.WidgetConstructor(
                ...
                false,
                {
                    ...
                    Update = function(L)
                        ...
                        local cP =
                            o._config.TextSize * 2 + o._config.ItemInnerSpacing.X * 2 + o._config.WindowPadding.X + 4
                            ...
                            if L.arguments.RowBg == false then
                                ...
                                for c_, B in L.CellInstances do
                                    ...
                                    B.BackgroundTransparency =
                                        d0 % 2 == 0 and o._config.TableRowBgAltTransparency or
                                        o._config.TableRowBgTransparency
                                end
                            end
            ...
            do
                ...
                local function dt(L, du)
                    ...
                    return Vector2.new(
                        math.clamp(du.X, dw, math.max(dy.X, dw)),
                        math.clamp(du.Y, dw, math.max(dy.Y, dw))
                    )
                end
                ...
                bI.InputBegan:Connect(
                    function(c8, dD)
                        if not dD and c8.UserInputType == Enum.UserInputType.MouseButton1 then
                            o.SetFocusedWindow(nil)
                        end
                        if
                            c8.KeyCode == Enum.KeyCode.Tab and
                                (bI:IsKeyDown(Enum.KeyCode.LeftControl) or bI:IsKeyDown(Enum.KeyCode.RightControl))
                         then
                            dp()
                        end
                        if c8.UserInputType == Enum.UserInputType.MouseButton1 then
                    ...
                    function(c8)
                        ...
                        if dc then
                            ...
                            local dA =
                                dL +
                                Vector2.new(
                                    dg == Enum.LeftRight.Left and dM.X or 0,
                                    df == Enum.TopBottom.Top and dM.Y or 0
                                )
                            local dN =
                                dv +
                                Vector2.new(
                ...
                bI.InputEnded:Connect(
                    function(c8, dD)
                        if
                            (c8.UserInputType == Enum.UserInputType.MouseButton1 or
                                c8.UserInputType == Enum.UserInputType.Touch) and
                                d9
                         then
                            local dI = d8.Instance.WindowButton
                            d9 = false
                    ...
                    true,
                    {
                        ...
                        Generate = function(L)
                            ...
                            dR.InputBegan:Connect(
                                function(c8)
                                    if
                                        c8.UserInputType == Enum.UserInputType.MouseMovement or
                                            c8.UserInputType == Enum.UserInputType.Keyboard
                                     then
                                        return
                                    end
                            ...
                            cD:getPropertyChangedSignal("CanvasPosition"):Connect(
                                function()
                            ...
                            e0.Size =
                                UDim2.new(
                                1,
                                o._config.WindowResizePadding.X * 2,
                                1,
                                o._config.WindowResizePadding.Y * 2
                            )
                            e0.Position =
                                UDim2.fromOffset(-o._config.WindowResizePadding.X, -o._config.WindowResizePadding.Y)
                            dR.AutomaticSize = Enum.AutomaticSize.None
    ...
    function(require, n, c, d)
        local eb = {
            colorDark = {
                ...
                TitleBgActiveColor = Color3.fromRGB(10, 10, 10),
                TitleBgActiveTransparency = 0,
                TitleBgCollapsedColor = Color3.fromRGB(0, 0, 0),
                TitleBgCollapsedTransparency = 0.5,
                FrameBgColor = Color3.fromRGB(140, 71, 196),
                FrameBgTransparency = 0.46,
                FrameBgHoveredColor = Color3.fromRGB(201, 66, 250),
                FrameBgHoveredTransparency = 0.46,
                FrameBgActiveColor = Color3.fromRGB(201, 66, 250),
                FrameBgActiveTransparency = 0.33,
                ButtonColor = Color3.fromRGB(140, 71, 196);
                ButtonTransparency = 0.6,
                ButtonHoveredColor = Color3.fromRGB(201, 66, 250),
                ButtonHoveredTransparency = 0,
                ButtonActiveColor = Color3.fromRGB(207, 15, 250),
                ButtonActiveTransparency = 0,
                HeaderColor = Color3.fromRGB(201, 66, 250),
                HeaderTransparency = 0.31,
                HeaderHoveredColor = Color3.fromRGB(201, 66, 250),
                HeaderHoveredTransparency = 0.2,
                HeaderActiveColor = Color3.fromRGB(201, 66, 250),
